...
<body class="text-center flex-column">
    ...
    <div class="table-responsive tabela">
        ...
        <thead class="thead-dark">
            ...
            <td>
                <a class="btn btn-primary btn-sm" href="alunos-editar.php?id=<?= $linha['id'] ?>"><i class="fa-regular fa-pen-to-square"></i></a>
                <a class="btn btn-danger btn-sm" href="alunos-excluir.php?id=<?= $linha['id'] ?>"><i class="fa-solid fa-xmark"></i></a>
            </td>
            </tr>
            <?php endforeach ?>
        </table>
