...
<body class="text-center flex-column">
  ...
  <h3 class="h3 mb-3 font-weight-normal mb-5">Gerenciar Diciplinas</h3>
  <ul class="nav nav-pills flex-column">
    <li class="nav-item">
      <a class="nav-link btn-dark mb-3" href="../sis-escolar/diciplinas-inserir.php">Adicionar Diciplina</a>
    </li>
    <li class="nav-item">
      <a class="nav-link btn-dark mb-3" href="../sis-escolar/diciplinas-listar.php">Listar Diciplinas</a>
    </li>
    <li class="nav-item">
