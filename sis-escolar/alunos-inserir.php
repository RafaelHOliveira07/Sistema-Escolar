                ...
                <div class="form-group col-3">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-dark btn-lg active">
                            <input type="radio" name="genero" id="genero1" checked autocomplete="off" value="0">Masculino
                        </label>
                        <label class="btn btn-dark btn-lg">
                            <input type="radio" name="genero" id="genero2" autocomplete="off" value="1">Feminino
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group col-3">
                    <div class="btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-dark btn-lg" for="statusMat">
                            <input type="checkbox" name="statusMat" checked autocomplete="off"> Mátricula Ativa
                        </label>
                    </div>
                </div>
