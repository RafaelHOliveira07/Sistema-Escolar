...
<body class="text-center flex-column">
    <h1 lass="font-weight-bold text-dark">Turma registrada com sucesso</h1>
    <div class="mt-3">
        <a href="../sis-escolar/turmas-listar.php" class="btn btn-lg btn-dark btn-lg px-5">Voltar</a>
        <a href="../sis-escolar/turmas-inserir.php" class="btn btn-lg btn-dark btn-lg px-3">Nova Turma</a>
    </div>
</body>
</html>